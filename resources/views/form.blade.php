                            ...
                            <div class="mx-auto max-w-xs">
                                <form action="{{ route('recette.store') }}" method="POST">
                                    <input
                                        ...
                                        type="text" placeholder="Nom de la recette" name="nom" />
                                    <input
                                        ...
                                        type="text" placeholder="Courte description" name= "description" />
                                    <textarea
                                        class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-orange-500 placeholder-orange-500 text-sm focus:outline-none focus:border-orange-500 focus:bg-white mt-5"
                                        placeholder="Liste des ingrédients" rows="4" name="ingredients"></textarea>
                                    <textarea
                                        class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-orange-500 placeholder-orange-500 text-sm focus:outline-none focus:border-orange-500 focus:bg-white mt-5"
                                        placeholder="Étapes de préparation" rows="4" name= "etapes"></textarea>
